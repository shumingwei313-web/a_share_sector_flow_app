...
const DEMO_SEARCH = [
  ...
  { code: "399006", name: "创业板指", market: "SZ", type: "A股指数", industry: "主要市场" },
  { code: "000688", name: "科创50", market: "SH", type: "A股指数", industry: "主要市场" },
  ...
  { code: "300502", name: "新易盛", market: "SZ", type: "A股", industry: "通信设备" },
  { code: "002156", name: "通富微电", market: "SZ", type: "A股", industry: "半导体" },
  { code: "600584", name: "长电科技", market: "SH", type: "A股", industry: "半导体" },
  { code: "002371", name: "北方华创", market: "SZ", type: "A股", industry: "半导体" },
  { code: "688012", name: "中微公司", market: "SH", type: "A股", industry: "半导体" },
  { code: "688256", name: "寒武纪", market: "SH", type: "A股", industry: "人工智能" },
  { code: "000063", name: "中兴通讯", market: "SZ", type: "A股", industry: "通信设备" },
  { code: "300124", name: "汇川技术", market: "SZ", type: "A股", industry: "机器人" },
  { code: "600406", name: "国电南瑞", market: "SH", type: "A股", industry: "电网设备" },
  { code: "002896", name: "中大力德", market: "SZ", type: "A股", industry: "机器人" },
  { code: "002472", name: "双环传动", market: "SZ", type: "A股", industry: "机器人" },
  { code: "300274", name: "阳光电源", market: "SZ", type: "A股", industry: "光伏设备" },
  { code: "600438", name: "通威股份", market: "SH", type: "A股", industry: "光伏设备" },
  { code: "600030", name: "中信证券", market: "SH", type: "A股", industry: "证券" },
  { code: "300059", name: "东方财富", market: "SZ", type: "A股", industry: "证券" },
  { code: "600276", name: "恒瑞医药", market: "SH", type: "A股", industry: "医药商业" },
  { code: "603259", name: "药明康德", market: "SH", type: "A股", industry: "医药商业" },
  { code: "300454", name: "深信服", market: "SZ", type: "A股", industry: "软件开发" },
  { code: "600570", name: "恒生电子", market: "SH", type: "A股", industry: "软件开发" },
  { code: "601899", name: "紫金矿业", market: "SH", type: "A股", industry: "有色金属" },
  { code: "603993", name: "洛阳钼业", market: "SH", type: "A股", industry: "有色金属" },
  { code: "300750", name: "宁德时代", market: "SZ", type: "A股", industry: "新能源车" },
  { code: "002594", name: "比亚迪", market: "SZ", type: "A股", industry: "新能源车" },
];
...
const DEMO_STOCKS_BY_SECTOR = {
  ...
  光伏设备: [
    ["300274", "阳光电源", 3.59, 9.6, 1.46, "逆变器"],
    ["600438", "通威股份", 10.02, 3.8, 1.25, "光伏概念"],
    ["688390", "固德威", 4.2, 5.1, 1.11, "储能概念"],
    ["300763", "锦浪科技", 3.8, 4.7, 1.08, "逆变器"],
    ["002459", "晶澳科技", 2.6, 3.2, 0.96, "TOPCon电池"],
    ["601012", "隆基绿能", 1.9, 2.8, 0.92, "HJT电池"],
  ],
  证券: [
    ["600030", "中信证券", 0.86, 6.4, 1.18, "券商概念"],
    ["300059", "东方财富", 1.24, 8.9, 1.27, "财富管理"],
    ["601688", "华泰证券", 0.92, 4.6, 1.09, "金融科技"],
    ["600837", "海通证券", 0.48, 2.8, 0.97, "券商概念"],
    ["000776", "广发证券", 0.66, 2.2, 0.94, "财富管理"],
    ["601211", "国泰君安", 0.55, 1.9, 0.9, "券商概念"],
  ],
  医药商业: [
    ["600276", "恒瑞医药", -0.8, -3.6, 0.88, "创新药"],
    ["603259", "药明康德", -1.2, -4.8, 0.91, "CRO"],
    ["000538", "云南白药", 0.4, 1.2, 0.82, "中药"],
    ["300015", "爱尔眼科", -0.6, -2.1, 0.79, "医疗服务"],
    ["600998", "九州通", -0.2, -1.5, 0.74, "医药商业"],
    ["300760", "迈瑞医疗", 0.3, 1.6, 0.86, "医疗器械"],
  ],
  人工智能: [
    ["688256", "寒武纪", 5.6, 9.9, 1.22, "AI芯片"],
    ["300308", "中际旭创", 10.01, 42.8, 1.24, "算力概念"],
    ["300502", "新易盛", 12.2, 31.4, 1.18, "算力概念"],
    ["002230", "科大讯飞", 4.8, 8.6, 1.17, "大模型"],
    ["688111", "金山办公", 3.9, 5.4, 1.05, "AI应用"],
    ["603019", "中科曙光", 4.2, 7.1, 1.12, "云计算"],
  ],
  软件开发: [
    ["300454", "深信服", 3.2, 4.6, 1.08, "网络安全"],
    ["600570", "恒生电子", 2.4, 3.8, 1.02, "金融科技"],
    ["300033", "同花顺", 2.9, 5.2, 1.18, "金融科技"],
    ["688111", "金山办公", 3.9, 5.4, 1.05, "AI应用"],
    ["002410", "广联达", 1.8, 2.1, 0.94, "工业软件"],
    ["600588", "用友网络", 1.6, 2.4, 0.91, "信创"],
  ],
  有色金属: [
    ["601899", "紫金矿业", 2.8, 16.6, 1.23, "黄金"],
    ["603993", "洛阳钼业", 2.1, 9.7, 1.18, "小金属"],
    ["000630", "铜陵有色", 1.7, 5.2, 1.05, "铜"],
    ["601600", "中国铝业", 1.4, 4.8, 1.02, "铝"],
    ["002466", "天齐锂业", 0.9, 3.1, 0.98, "锂矿"],
    ["600111", "北方稀土", 1.2, 3.7, 1.01, "稀土永磁"],
  ],
  新能源车: [
    ["300750", "宁德时代", 1.8, 12.8, 1.04, "锂电池"],
    ["002594", "比亚迪", 1.2, 9.4, 0.98, "新能源汽车"],
    ["002050", "三花智控", 2.3, 6.1, 1.12, "汽车零部件"],
    ["601689", "拓普集团", 2.1, 4.9, 1.06, "一体化压铸"],
    ["002074", "国轩高科", 1.4, 3.5, 0.93, "固态电池"],
    ["300001", "特锐德", 1.9, 2.8, 1.01, "充电桩"],
  ],
};
